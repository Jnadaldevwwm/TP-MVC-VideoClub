...
function afficheTitre(){
    ...
    <table width="100%" border="0">
        <tr>
        <td ><a href="VCIAccueil.php"><img src="../public/images/VCLogo.gif" border="0"></a></td>
        <td class="centrer">
                <div class="titrevideo">Vidéo-Club</div>
                <div class="soustitrevideo">Administration</div>
        </td>
        <td><?= $cejour['mday'] . ' ' . $libmois[$cejour['mon']] . ' ' . $cejour['year'];?> <br /><a href="VCIAccueil.php">Site</a></td>
        </tr>
    </table>
<?php
}
